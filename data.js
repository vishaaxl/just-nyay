export const pages = [
  {
    id: 0,
    title: "criminal",
    heading: "Connect with Best Criminal Lawyers / Advocates in India",
    content:
      "Whether a crime has been committed against you or you have been falsely or willfully implicated in a criminal act or the police are harassing you unnecessarily or you are having a fight with a neighbour or a relative or somebody forcibly taking possession of your property. Use Just Nyay to consult top notch criminal lawyers in India to defend your rights at each stage of your case - from filing an anticipatory bail to a regular bail to an appeal after conviction or to quash an FIR. ",
  },
  {
    id: 3,
    title: "property",
    heading: "Connect with Best Criminal Lawyers / Advocates in India",
    content:
      "Problem Likes illegal possession, ancestral property settlement, builder-buyer Agreement, builder delay in possession, property disputes among family, and real estate disputes under RERA act. Use Just Nyay to consult top notch property lawyers in India to file or defend a partition suit, title dispute and for due diligence of your property's documents. ",
  },
  {
    id: 6,
  ...
  },
  {
    id: 9,
    title: "cyber-crime",
    heading: "Connect with Best Cyber Crime Lawyers / Advocates in India",
    content:
      "Cybercrime, also called computer crime, the use of a computer as an instrument to further illegal ends, such as committing fraud, trafficking in child pornography and intellectual property, stealing identities, or violating privacy. Connect with Just Nyay to hire a top cyber crime lawyer in India when someone uses a computer in a crime against you, such as stealing your information, committing theft, blackmailing you, or cyber-stalking. ",
  },
  {
    id: 12,
    title: "divorce",
...
<li>•		We give the best competent and personalised representation for your Muslim law dispute through expert lawyers who will discuss your case with you one-on-one.
  ...
  },
  {
    ...
    heading:
      "Connect with Best Medical Negligence Lawyers / Advocates in India",
    content:
      "If you were admitted to a hospital for your treatment and the hospital did not treat you properly despite charging a huge fee, then this case is made of medical negligence, in which the hospital, doctor, nurse, hospital management can be sued. Also there are cases where a patient dies due to negligence then his family members are entitled to get huge compensation. Contact Just Nyay immediately for such cases as we have thousands of lawyers to fight medical negligence cases.",
  },
  {
    id: 27,
    title: "motor-accident",
    heading: "Connect with Best Motor Accident Lawyers / Advocates in India",
    content:
      "If there is an accident with a bike or car on the road and that incident leads to serious injury or death, you are entitled to compensation. Whether that compensation is given by a private person or an insurance company. Just Nyay will provide you with a lawyer who has vast experience in getting compensation under the MACT Act. Use Just Nyay for top Legal consultant in India. ",
  },
  {
    id: 30,
    title: "wills-trust",
    heading: "Connect with Best Wills / Trusts Lawyers / Advocates in India",
    content:
      "Making a will is the best way to decide how you want to manage your property while you are living or who and when you want to give the management of your property after you. How to make a Will and make it legally valid? For all these questions contact Just Nyay as soon as possible. Use Just Nyay to hire a top lawyer in India to draft and register your Will, form a trust and draft a trust deed.  ",
  },
  {
    id: 33,
...
<li>•	Our online labour law consultation is a welcoming place in which to discuss your case in complete confidentiality.
  ...
  },
  {
    id: 36,
    title: "arbitration",
    heading: "Connect with Best Arbitration Lawyers / Advocates in India",
    content:
      "There is a heavy burden of cases on the courts of the country. Millions of cases are pending in the courts and if you do not want any of your disputes to go to court then Arbitration / Alternative Dispute Resolution (ADR) is the best way to resolve your dispute without litigation. Use Just Nyay to find a top mediation lawyer in India for ICC Arbitrations, to initiate or respond to any Arbitral Proceedings and for Alternate Dispute Resolution (ADR). ",
  },
  {
    id: 39,
...
<li>•	Your legal concerns are all heard by our attorneys, who also offer advice on how to handle them. 
  ...
  },
  {
    ...
    content:
      "If you are an entrepreneurial person and you have a unique idea to do business, then know how to start a startup. What legal action will be required to start any start up. What are the plans of the government regarding startups and how will their legal action be taken? Just Nyay has a team of experienced lawyers to answer all these questions, so what's the delay, contact us soon.",
  },
  {
    id: 48,
...
<li>•		The fees of our GST lawyers are well within your case budget.
  ...
  },
  {
    id: 54,
    title: "corporate",
    heading: "Connect with Best Corporate Lawyers / Advocates in India",
    content:
      "Corporate law is a diverse legal field that works in both the business and legal industries, covering governance, contracts, business transactions and the legalities of a business's daily operations. A corporate lawyer ensures the legality of business transactions in compliance to the law, advising corporations and businesses on their legal rights and duties. Connect with Just Nyay to hire a top corporate lawyer in India for drafting your company's contracts, agreements, startup advice, mergers & acquisitions (M&A), shareholder agreements and any other corporate legal requirements.",
  },
  {
    id: 57,
    title: "tax",
    heading: "Connect with Best Tax Lawyers / Advocates in India",
    content:
...
`,
  },
  {
    id: 78,
    title: "supreme-court",
    heading: "Connect with Best Supreme Court Lawyers/Advocates in India ",
    content:
      "The Supreme Court of India is the highest court of India and the lawyers working here are highly educated and knowledgeable in the law. Connect with Just Nyay to consult a top Supreme Court lawyer to file a Special Leave Petition (SLP), Public Interest Litigation (PIL) , Review petition, Inter State transfer cases, or to file a matter that has been dismissed by the high court and needs to be appealed in the Supreme Court. ",
  },
  {
    id: 81,
    title: "insurance",
    heading: "Connect with Best Insurance Lawyers / Advocates in India",
    content:
...
export const marriageFaqs = [
  {
    id: 1,
    question:
      "Are there any benefits of registering my marriage within 90 days of solemnization?",
  ...
  },
  {
    id: 2,
    question:
      "If my marriage isn't registered, do I still need to go through a divorce process?",
    ans: "Your marriage is still valid, so you will have to go through the divorce process as prescribed by law",
  },
  {
    id: 3,
    question:
      "Why do I need to get my marriage registered and obtain the marriage certificate?",
    ans: "After registration of marriage, marriage certificate is issued. The marriage certificate is the conclusive proof of your marriage<ul><li>- Applying for dependant VISA or passport</li><li>- Opening of joint bank account after marriage</li><li>- In the unfortunate circumstance of your spouse passing away without nomination, it can be used to claim deposits in bank, insurance benefits</li></ul>",
  },
  {
    id: 4,
    question: "If my marriage isn't registered, is it still a valid marriage?",
