        ...
        <div className={styles.about}>
          <div className={styles.content}>
            <div className="line_heading">
              ...
              <h4>Who Should Look For Second Opinion</h4>
            </div>

            <h2 className={styles.about_title}>Second Opinion</h2>
            <p className={styles.about_sub_title}>
              <ul className={styles.para} style={{ lineHeight: "2.5" }}>
                <li>1. Is your case also going on in court?</li>
                <li>
                  2. Have you also been waiting for years for your case to end
                  soon?
                </li>
                <li>
                  3. Do you also feel that the legal advice you are getting is
                  not enough?
                </li>

                <li>
                  4. Do you also think that it will be better if you get this
                  legal advice from a big lawyer of the country?
                </li>
                <li>
                  5. Are you a Legal Practitioner and stuck with some aspect of
                  the case?
                </li>
                <li>
                  6. Are you a Law graduate and want to talk to the top lawyers
                  of the country about your career?
                </li>
              </ul>
            </p>
          </div>
