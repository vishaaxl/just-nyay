  ...
  return (
    <>
      ...
      <div className="container" style={{ lineHeight: 1.4 }}>
        ...
        >
          Privacy Policy for Advozone India Private Limited
        </p>
        <p>
          At Just Nyay, accessible from{" "}
          <a href="https://justnyay.com/">https://justnyay.com/</a>, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Just Nyay and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in Just Nyay. This policy is not applicable to
        ...
        <p>
          &bull;&nbsp; &nbsp;&nbsp;Provide, operate, and maintain our website
        </p>
        <p>
          &bull;&nbsp; &nbsp;&nbsp;Improve, personalize, and expand our website
        </p>
        <p>
          &bull;&nbsp; &nbsp;&nbsp;Understand and analyze how you use our
          website
        </p>
        <p>
          &bull;&nbsp; &nbsp;&nbsp;Develop new products, services, features, and
          functionality
        </p>
        <p>
          &bull;&nbsp; &nbsp;&nbsp;Communicate with you, either directly or
        ...
        <p>&bull;&nbsp; &nbsp;&nbsp;Send you emails</p>
        <p>&bull;&nbsp; &nbsp;&nbsp;Find and prevent fraud</p>
        <p>Log Files</p>
        <p>
          Just Nyay follows a standard procedure of using log files. These files
        ...
        <p>
          Like any other website, Just Nyay uses &apos;cookies&apos;. These
        ...
        <p>
          ...
          advertising partners of Just Nyay.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Just Nyay, which are sent
        ...
        <p>
          Note that Just Nyay has no access to or control over these cookies
          that are used by third-party advertisers.
        </p>
        <p>Third Party Privacy Policies</p>
        <p>
          Just Nyay&apos;s Privacy Policy does not apply to other advertisers or
        ...
        <p>
          Just Nyay does not knowingly collect any Personal Identifiable
